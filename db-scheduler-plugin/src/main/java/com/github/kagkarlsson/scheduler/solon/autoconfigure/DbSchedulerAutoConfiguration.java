 ...
 */
package com.github.kagkarlsson.scheduler.solon.autoconfigure;
...
import com.github.kagkarlsson.scheduler.solon.config.DbSchedulerStarter;
import com.github.kagkarlsson.scheduler.solon.config.startup.AbstractSchedulerStarter;
import com.github.kagkarlsson.scheduler.solon.config.startup.ImmediateStart;
...
@Inject("${db-scheduler}")
@Configuration
public class DbSchedulerAutoConfiguration implements LifecycleBean {
  ...
  @Condition(onClass = DataSource.class, onMissingBean = DataSource.class)
  ...
  public void stop() throws Throwable {
    DbSchedulerCustomizer customizerBean = Solon.context().getBean(DbSchedulerCustomizer.class);
    StatsRegistry statsRegistryBean = Solon.context().getBean(StatsRegistry.class);
    this.scheduler(customizerBean,statsRegistryBean);
  }
}
